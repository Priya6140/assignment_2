      ...
      return (
          <div className="list-item row jc-space-between">
              ...
              <i className="fas fa-trash" alt="delete-task"
                   onClick={() => props.deleteTask(props.index)}></i>
          </div>
      );
  }
    return (
        <div className="app-background">
            <p className="heading-text"> TO-DO APP <span role="img" aria-label="react"></span></p>
            <div className="task-container column">
                ...
                {toDoList?.length ?
                    ...
                    <p className="no-item-text"><span role="img" aria-label="react"></span> &nbsp;</p>}
            </div>
        </div>
    );
}
